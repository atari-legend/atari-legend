...
/**
 * Rename article_user_comments.article_user_comments_id to id.
 *
...
return new class extends Migration
{
    ...
    {
        foreach ($this->redundantIndexes('article_user_comments') as $index) {
            Schema::table('article_user_comments', fn (Blueprint $t) => $t->dropIndex($index));
        }

        Schema::table('article_user_comments', fn (Blueprint $t) => $t->renameColumn('article_user_comments_id', 'id'));
    }

    public function down(): void
    {
        Schema::table('article_user_comments', fn (Blueprint $t) => $t->renameColumn('id', 'article_user_comments_id'));
    }
