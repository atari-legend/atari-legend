...
/**
 * Rename crew_individual.crew_individual_id to id.
 *
...
return new class extends Migration
{
    ...
    {
        Schema::table('crew_individual', fn (Blueprint $t) => $t->renameColumn('crew_individual_id', 'id'));
    }

    public function down(): void
    {
        Schema::table('crew_individual', fn (Blueprint $t) => $t->renameColumn('id', 'crew_individual_id'));
    }
};
