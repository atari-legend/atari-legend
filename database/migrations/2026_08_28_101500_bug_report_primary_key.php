...
/**
 * Rename bug_report.bug_report_id to id.
 *
...
return new class extends Migration
{
    ...
    {
        Schema::table('bug_report', fn (Blueprint $t) => $t->renameColumn('bug_report_id', 'id'));
    }

    public function down(): void
    {
        Schema::table('bug_report', fn (Blueprint $t) => $t->renameColumn('id', 'bug_report_id'));
    }
};
