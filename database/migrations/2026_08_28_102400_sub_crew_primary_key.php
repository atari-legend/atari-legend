...
/**
 * Rename sub_crew.sub_crew_id to id.
 *
...
return new class extends Migration
{
    ...
    {
        Schema::table('sub_crew', fn (Blueprint $t) => $t->renameColumn('sub_crew_id', 'id'));
    }

    public function down(): void
    {
        Schema::table('sub_crew', fn (Blueprint $t) => $t->renameColumn('id', 'sub_crew_id'));
    }
};
