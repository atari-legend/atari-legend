...
/**
 * Rename screenshot_game_submitinfo.screenshot_game_submitinfo_id to id.
 *
...
return new class extends Migration
{
    ...
    {
        Schema::table('screenshot_game_submitinfo', fn (Blueprint $t) => $t->renameColumn('screenshot_game_submitinfo_id', 'id'));
    }

    public function down(): void
    {
        Schema::table('screenshot_game_submitinfo', fn (Blueprint $t) => $t->renameColumn('id', 'screenshot_game_submitinfo_id'));
    }
};
