...
/**
 * Rename interview_user_comments.interview_user_comments_id to id.
 *
...
return new class extends Migration
{
    ...
    {
        Schema::table('interview_user_comments', fn (Blueprint $t) => $t->renameColumn('interview_user_comments_id', 'id'));
    }

    public function down(): void
    {
        Schema::table('interview_user_comments', fn (Blueprint $t) => $t->renameColumn('id', 'interview_user_comments_id'));
    }
};
