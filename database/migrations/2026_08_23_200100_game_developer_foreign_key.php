...
/**
 * Rename game_developer.dev_pub_id to pub_dev_id.
 *
 * The table it points at is pub_dev, and game_release.pub_dev_id and
 * pub_dev_text.pub_dev_id already say so; this was the last one holding the
...
return new class extends Migration
{
    ...
    {
        $this->renameForeignKeyColumn('game_developer', 'dev_pub_id', 'pub_dev_id');
    }

    public function down(): void
    {
        $this->renameForeignKeyColumn('game_developer', 'pub_dev_id', 'dev_pub_id');
    }
