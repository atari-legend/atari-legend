...
/**
 * Rename review_user_comments.review_user_comments_id to id.
 *
...
return new class extends Migration
{
    ...
    {
        foreach ($this->redundantIndexes('review_user_comments') as $index) {
            Schema::table('review_user_comments', fn (Blueprint $t) => $t->dropIndex($index));
        }

        Schema::table('review_user_comments', fn (Blueprint $t) => $t->renameColumn('review_user_comments_id', 'id'));
    }

    public function down(): void
    {
        Schema::table('review_user_comments', fn (Blueprint $t) => $t->renameColumn('id', 'review_user_comments_id'));
    }
