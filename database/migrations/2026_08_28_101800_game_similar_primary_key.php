...
/**
 * Rename game_similar.game_similar_id to id.
 *
...
return new class extends Migration
{
    ...
    {
        Schema::table('game_similar', fn (Blueprint $t) => $t->renameColumn('game_similar_id', 'id'));
    }

    public function down(): void
    {
        Schema::table('game_similar', fn (Blueprint $t) => $t->renameColumn('id', 'game_similar_id'));
    }
};
