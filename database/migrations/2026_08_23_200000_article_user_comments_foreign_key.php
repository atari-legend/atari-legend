...
/**
 * Rename article_user_comments.comments_id to comment_id.
 *
 * The other three comment pivots already say comment_id; this one was the odd
 * one out, and it is the smallest rename in the campaign, which is why it
 * goes first.
 *
...
return new class extends Migration
{
    ...
    {
        $this->renameForeignKeyColumn('article_user_comments', 'comments_id', 'comment_id');
    }

    public function down(): void
    {
        $this->renameForeignKeyColumn('article_user_comments', 'comment_id', 'comments_id');
    }
