                    ...
                    <div class="card-body p-0 d-flex flex-column striped">
                            ...
                            <div class="card-footer text-end">
                                @if ($disk->menuDiskDump !== null)
                                    <a title="Copy checksum" class="ms-1 text-muted" data-copy-text="{{ $disk->menuDiskDump->sha512 }}" href="javascript:;"><i class="far fa-copy"></i></a>
                                    ...
                                    <a href="{{ asset('storage/zips/menus/'.$disk->menuDiskDump->id.'.zip') }}"
                                        ...
                                        <i title="Download {{ $disk->download_filename }}" class="fas fa-download"></i>
                                    </a>
                                @else
