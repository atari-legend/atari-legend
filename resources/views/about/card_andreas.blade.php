<div class="card bg-dark mb-4">
    ...
    <div class="card-body p-2">
        ...
        <p class="card-text text-center">
            <img class="w-50" width="800" height="600" src="{{ asset('images/class_al/Andreas2.jpg') }}" alt="Andreas doing the Vulcan salute" loading="lazy">
        </p>
        <p class="card-text">
        ...
        <p class="card-text text-center">
            <img class="w-50" width="2048" height="1536" src="{{ asset('images/class_al/Andreas.jpg') }}" alt="Andreas doing martial arts" loading="lazy">
        </p>
    </div>
    <div class="card-body p-2">
        ...
        @foreach ($comments as $comment)
            <h6 class="text-muted">{{ $comment->name}} - {{ $comment->created_at?->format('F j, Y') }}</h6>
