    ...
    <div class="card-body lightbox-gallery">
        ...
        <section id="cd-timeline" class="cd-container">
            ...
            <div class="cd-timeline-block">
                ...
                <div class="timeline-content text-center p-2 mb-4 mt-4">
                    <h4 class="text-primary">Atari Legend 2.0 beta is released</h4>
                    <p>
            ...
            <div class="cd-timeline-block">
                ...
                <div class="timeline-content text-center p-2 mb-4 mt-4">
                    <h4 class="text-primary">Atari Legend demo</h4>
                    <p>
                    ...
                    <h6 class="text-muted">July 2017</h6>
                </div> <!-- timeline-content text-center p-2 mb-4 mt-4 -->
            </div> <!-- cd-timeline-block -->
            ...
            <div class="cd-timeline-block">
                ...
                <div class="timeline-content text-center p-2 mb-4 mt-4">
                    <h4 class="text-primary">Reaching out</h4>
                    <p>
                    ...
                    <h6 class="text-muted">April 2015</h6>
                </div> <!-- timeline-content text-center p-2 mb-4 mt-4 -->
            </div> <!-- cd-timeline-block -->
            ...
            <div class="cd-timeline-block">
                ...
                <div class="timeline-content text-center p-2 mb-4 mt-4">
                    <h4 class="text-primary">Old habits never die</h4>
                    <p>
                    ...
                    <h6 class="text-muted">January 2015</h6>
                </div> <!-- timeline-content text-center p-2 mb-4 mt-4 -->
            </div> <!-- cd-timeline-block -->
            ...
            <div class="cd-timeline-block">
                ...
                <div class="timeline-content text-center p-2 mb-4 mt-4">
                    <h4 class="text-primary">STonish starts a revival</h4>
                    <p>
            ...
            <div class="cd-timeline-block">
                ...
                <div class="timeline-content text-center p-2 mb-4 mt-4">
                    <h4 class="text-primary">Donation day</h4>
                    <p>
                    ...
                    <h6 class="text-muted">October 2012</h6>
                </div> <!-- timeline-content text-center p-2 mb-4 mt-4 -->
            </div> <!-- cd-timeline-block -->
            ...
            <div class="cd-timeline-block">
                ...
                <div class="timeline-content text-center p-2 mb-4 mt-4">
                    <h4 class="text-primary">Ice Ice baby</h4>
                    <p>
                    ...
                    <h6 class="text-muted">March 2008</h6>
                </div> <!-- timeline-content text-center p-2 mb-4 mt-4 -->
            </div> <!-- cd-timeline-block -->
            ...
            <div class="cd-timeline-block">
                ...
                <div class="timeline-content text-center p-2 mb-4 mt-4">
                    <h4 class="text-primary">One big happy family</h4>
                    <p>
                    ...
                    <h6 class="text-muted">February 2005</h6>
                </div> <!-- timeline-content text-center p-2 mb-4 mt-4 -->
            </div> <!-- cd-timeline-block -->
            ...
            <div class="cd-timeline-block">
                ...
                <div class="timeline-content text-center p-2 mb-4 mt-4">
                    <h4 class="text-primary">Atari legend is done</h4>
                    <p>
            ...
            <div class="cd-timeline-block">
                ...
                <div class="timeline-content text-center p-2 mb-4 mt-4">
                    <h4 class="text-primary">Development of Atari Legend has begun</h4>
                    <p>
                    ...
                    <br>
                    <h6 class="text-muted">December 2002</h6>
                </div> <!-- timeline-content text-center p-2 mb-4 mt-4 -->
            </div> <!-- cd-timeline-block -->
            ...
            <div class="cd-timeline-block">
                ...
                <div class="timeline-content text-center p-2 mb-4 mt-4">
                    <h4 class="text-primary">Missing Atari ST games project</h4>
                    <p>
            ...
            <div class="cd-timeline-block">
                ...
                <div class="timeline-content text-center p-2 mb-4 mt-4">
                    <h4 class="text-primary">The ST Graveyard v2.0 is released</h4>
                    <p>
            ...
            <div class="cd-timeline-block">
                ...
                <div class="timeline-content text-center p-2 mb-4 mt-4">
                    <h4 class="text-primary">Atarizone enters the scene</h4>
                    <p>
            ...
            <div class="cd-timeline-block">
                ...
                <div class="timeline-content text-center p-2 mb-4 mt-4">
                    <h4 class="text-primary">Atari-Forum is born</h4>
                    <p>
            ...
            <div class="cd-timeline-block">
                ...
                <div class="timeline-content text-center p-2 mb-4 mt-4">
                    <h4 class="text-primary">The ST Graveyard is released</h4>
                    <p>
            ...
            <div class="cd-timeline-block">
                ...
                <div class="timeline-content text-center p-2 mb-4 mt-4">
                    <h4 class="text-primary">Pacigame sees the light of day</h4>
                    <p>
            ...
            <div class="cd-timeline-block">
                ...
                <div class="timeline-content text-center p-2 mb-4 mt-4">
                    <h4 class="text-primary">Pacidemo opens its doors</h4>
                    <p>
