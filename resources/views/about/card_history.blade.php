        ...
        <section id="cd-timeline" class="cd-container">
            <div class="cd-timeline-block">
                ...
                <div class="timeline-content text-center p-2 mb-4 mt-4">
                    <h3 class="text-primary text-h5">The future of Atari Legend</h3>
                    <p>
                    ...
                    <p class="text-muted font-weight-bold">Future</p>
            ...
            <div class="cd-timeline-block">
                ...
                <div class="timeline-content text-center p-2 mb-4 mt-4">
                    <h3 class="text-primary text-h5">Atari Legend 2.0 beta is released</h3>
                    <p>
                    ...
                    <p class="text-muted font-weight-bold">October 2017</p>
                </div> <!-- timeline-content text-center p-2 mb-4 mt-4 -->
            </div> <!-- cd-timeline-block -->
            ...
            <div class="cd-timeline-block">
                ...
                <div class="timeline-content text-center p-2 mb-4 mt-4">
                    <h3 class="text-primary text-h5">Atari Legend demo</h3>
                    <p>
                    ...
                    <p class="text-muted font-weight-bold">July 2017</p>
                </div> <!-- timeline-content text-center p-2 mb-4 mt-4 -->
            </div> <!-- cd-timeline-block -->
            ...
            <div class="cd-timeline-block">
                ...
                <div class="timeline-content text-center p-2 mb-4 mt-4">
                    <h3 class="text-primary text-h5">Reaching out</h3>
                    <p>
                    ...
                    <p class="text-muted font-weight-bold">April 2015</p>
                </div> <!-- timeline-content text-center p-2 mb-4 mt-4 -->
            </div> <!-- cd-timeline-block -->
            ...
            <div class="cd-timeline-block">
                ...
                <div class="timeline-content text-center p-2 mb-4 mt-4">
                    <h3 class="text-primary text-h5">Old habits never die</h3>
                    <p>
                    ...
                    <p class="text-muted font-weight-bold">January 2015</p>
                </div> <!-- timeline-content text-center p-2 mb-4 mt-4 -->
            </div> <!-- cd-timeline-block -->
            ...
            <div class="cd-timeline-block">
                ...
                <div class="timeline-content text-center p-2 mb-4 mt-4">
                    <h3 class="text-primary text-h5">STonish starts a revival</h3>
                    <p>
                    ...
                    <p class="text-muted font-weight-bold">October 2014</p>
                </div> <!-- timeline-content text-center p-2 mb-4 mt-4 -->
            </div> <!-- cd-timeline-block -->
            ...
            <div class="cd-timeline-block">
                ...
                <div class="timeline-content text-center p-2 mb-4 mt-4">
                    <h3 class="text-primary text-h5">Donation day</h3>
                    <p>
                    ...
                    <p class="text-muted font-weight-bold">October 2012</p>
                </div> <!-- timeline-content text-center p-2 mb-4 mt-4 -->
            </div> <!-- cd-timeline-block -->
            ...
            <div class="cd-timeline-block">
                ...
                <div class="timeline-content text-center p-2 mb-4 mt-4">
                    <h3 class="text-primary text-h5">Ice Ice baby</h3>
                    <p>
                    ...
                    <p class="text-muted font-weight-bold">March 2008</p>
                </div> <!-- timeline-content text-center p-2 mb-4 mt-4 -->
            </div> <!-- cd-timeline-block -->
            ...
            <div class="cd-timeline-block">
                ...
                <div class="timeline-content text-center p-2 mb-4 mt-4">
                    <h3 class="text-primary text-h5">One big happy family</h3>
                    <p>
                    ...
                    <p class="text-muted font-weight-bold">February 2005</p>
                </div> <!-- timeline-content text-center p-2 mb-4 mt-4 -->
            </div> <!-- cd-timeline-block -->
            ...
            <div class="cd-timeline-block">
                ...
                <div class="timeline-content text-center p-2 mb-4 mt-4">
                    <h3 class="text-primary text-h5">Atari legend is done</h3>
                    <p>
                    ...
                    <p class="text-muted font-weight-bold">March 2004</p>
                </div> <!-- timeline-content text-center p-2 mb-4 mt-4 -->
            </div> <!-- cd-timeline-block -->
            ...
            <div class="cd-timeline-block">
                ...
                <div class="timeline-content text-center p-2 mb-4 mt-4">
                    <h3 class="text-primary text-h5">Development of Atari Legend has begun</h3>
                    <p>
                    ...
                    <br>
                    <p class="text-muted font-weight-bold">December 2002</p>
                </div> <!-- timeline-content text-center p-2 mb-4 mt-4 -->
            </div> <!-- cd-timeline-block -->
            ...
            <div class="cd-timeline-block">
                ...
                <div class="timeline-content text-center p-2 mb-4 mt-4">
                    <h3 class="text-primary text-h5">Missing Atari ST games project</h3>
                    <p>
                    ...
                    <p class="text-muted font-weight-bold">November 2002</p>
                </div> <!-- timeline-content text-center p-2 mb-4 mt-4 -->
            </div> <!-- cd-timeline-block -->
            ...
            <div class="cd-timeline-block">
                ...
                <div class="timeline-content text-center p-2 mb-4 mt-4">
                    <h3 class="text-primary text-h5">The ST Graveyard v2.0 is released</h3>
                    <p>
            ...
            <div class="cd-timeline-block">
                ...
                <div class="timeline-content text-center p-2 mb-4 mt-4">
                    <h3 class="text-primary text-h5">Atarizone enters the scene</h3>
                    <p>
                    ...
                    <p class="text-muted font-weight-bold">May 2002</p>
                </div> <!-- timeline-content text-center p-2 mb-4 mt-4 -->
            </div> <!-- cd-timeline-block -->
            ...
            <div class="cd-timeline-block">
                ...
                <div class="timeline-content text-center p-2 mb-4 mt-4">
                    <h3 class="text-primary text-h5">Atari-Forum is born</h3>
                    <p>
            ...
            <div class="cd-timeline-block">
                ...
                <div class="timeline-content text-center p-2 mb-4 mt-4">
                    <h3 class="text-primary text-h5">The ST Graveyard is released</h3>
                    <p>
                    ...
                    <p class="text-muted font-weight-bold">June 2001</p>
                </div> <!-- timeline-content text-center p-2 mb-4 mt-4 -->
            </div> <!-- cd-timeline-block -->
            ...
            <div class="cd-timeline-block">
                ...
                <div class="timeline-content text-center p-2 mb-4 mt-4">
                    <h3 class="text-primary text-h5">Pacigame sees the light of day</h3>
                    <p>
                    ...
                    <p class="text-muted font-weight-bold">May 2001</p>
                </div> <!-- timeline-content text-center p-2 mb-4 mt-4 -->
            </div> <!-- cd-timeline-block -->
            ...
            <div class="cd-timeline-block">
                ...
                <div class="timeline-content text-center p-2 mb-4 mt-4">
                    <h3 class="text-primary text-h5">Pacidemo opens its doors</h3>
                    <p>
                    ...
                    <p class="text-muted font-weight-bold">August 1997</p>
                </div> <!-- timeline-content text-center p-2 mb-4 mt-4 -->
            </div> <!-- cd-timeline-block -->
