        ...
        <section id="cd-timeline" class="cd-container">
            <div class="cd-timeline-block">
                ...
                <div class="timeline-content text-center p-2 mb-4 mt-4">
                    <h3 class="text-primary">The future of Atari Legend</h3>
                    <p>
            ...
            <div class="cd-timeline-block">
                ...
                <div class="timeline-content text-center p-2 mb-4 mt-4">
                    <h3 class="text-primary">Atari Legend 2.0 beta is released</h3>
                    <p>
            ...
            <div class="cd-timeline-block">
                ...
                <div class="timeline-content text-center p-2 mb-4 mt-4">
                    <h3 class="text-primary">Atari Legend demo</h3>
                    <p>
            ...
            <div class="cd-timeline-block">
                ...
                <div class="timeline-content text-center p-2 mb-4 mt-4">
                    <h3 class="text-primary">Reaching out</h3>
                    <p>
                    ...
                    <p class="text-muted">April 2015</p>
                </div> <!-- timeline-content text-center p-2 mb-4 mt-4 -->
            </div> <!-- cd-timeline-block -->
            ...
            <div class="cd-timeline-block">
                ...
                <div class="timeline-content text-center p-2 mb-4 mt-4">
                    <h3 class="text-primary">Old habits never die</h3>
                    <p>
                    ...
                    <p class="text-muted">January 2015</p>
                </div> <!-- timeline-content text-center p-2 mb-4 mt-4 -->
            </div> <!-- cd-timeline-block -->
            ...
            <div class="cd-timeline-block">
                ...
                <div class="timeline-content text-center p-2 mb-4 mt-4">
                    <h3 class="text-primary">STonish starts a revival</h3>
                    <p>
            ...
            <div class="cd-timeline-block">
                ...
                <div class="timeline-content text-center p-2 mb-4 mt-4">
                    <h3 class="text-primary">Donation day</h3>
                    <p>
                    ...
                    <p class="text-muted">October 2012</p>
                </div> <!-- timeline-content text-center p-2 mb-4 mt-4 -->
            </div> <!-- cd-timeline-block -->
            ...
            <div class="cd-timeline-block">
                ...
                <div class="timeline-content text-center p-2 mb-4 mt-4">
                    <h3 class="text-primary">Ice Ice baby</h3>
                    <p>
                    ...
                    <p class="text-muted">March 2008</p>
                </div> <!-- timeline-content text-center p-2 mb-4 mt-4 -->
            </div> <!-- cd-timeline-block -->
            ...
            <div class="cd-timeline-block">
                ...
                <div class="timeline-content text-center p-2 mb-4 mt-4">
                    <h3 class="text-primary">One big happy family</h3>
                    <p>
                    ...
                    <p class="text-muted">February 2005</p>
                </div> <!-- timeline-content text-center p-2 mb-4 mt-4 -->
            </div> <!-- cd-timeline-block -->
            ...
            <div class="cd-timeline-block">
                ...
                <div class="timeline-content text-center p-2 mb-4 mt-4">
                    <h3 class="text-primary">Atari legend is done</h3>
                    <p>
                    ...
                    <p class="text-muted">March 2004</p>
                </div> <!-- timeline-content text-center p-2 mb-4 mt-4 -->
            </div> <!-- cd-timeline-block -->
            ...
            <div class="cd-timeline-block">
                ...
                <div class="timeline-content text-center p-2 mb-4 mt-4">
                    <h3 class="text-primary">Development of Atari Legend has begun</h3>
                    <p>
                    ...
                    <br>
                    <p class="text-muted">December 2002</p>
                </div> <!-- timeline-content text-center p-2 mb-4 mt-4 -->
            </div> <!-- cd-timeline-block -->
            ...
            <div class="cd-timeline-block">
                ...
                <div class="timeline-content text-center p-2 mb-4 mt-4">
                    <h3 class="text-primary">Missing Atari ST games project</h3>
                    <p>
                    ...
                    <p class="text-muted">November 2002</p>
                </div> <!-- timeline-content text-center p-2 mb-4 mt-4 -->
            </div> <!-- cd-timeline-block -->
            ...
            <div class="cd-timeline-block">
                ...
                <div class="timeline-content text-center p-2 mb-4 mt-4">
                    <h3 class="text-primary">The ST Graveyard v2.0 is released</h3>
                    <p>
            ...
            <div class="cd-timeline-block">
                ...
                <div class="timeline-content text-center p-2 mb-4 mt-4">
                    <h3 class="text-primary">Atarizone enters the scene</h3>
                    <p>
            ...
            <div class="cd-timeline-block">
                ...
                <div class="timeline-content text-center p-2 mb-4 mt-4">
                    <h3 class="text-primary">Atari-Forum is born</h3>
                    <p>
            ...
            <div class="cd-timeline-block">
                ...
                <div class="timeline-content text-center p-2 mb-4 mt-4">
                    <h3 class="text-primary">The ST Graveyard is released</h3>
                    <p>
                    ...
                    <p class="text-muted">June 2001</p>
                </div> <!-- timeline-content text-center p-2 mb-4 mt-4 -->
            </div> <!-- cd-timeline-block -->
            ...
            <div class="cd-timeline-block">
                ...
                <div class="timeline-content text-center p-2 mb-4 mt-4">
                    <h3 class="text-primary">Pacigame sees the light of day</h3>
                    <p>
            ...
            <div class="cd-timeline-block">
                ...
                <div class="timeline-content text-center p-2 mb-4 mt-4">
                    <h3 class="text-primary">Pacidemo opens its doors</h3>
                    <p>
                    ...
                    <p class="text-muted">August 1997</p>
                </div> <!-- timeline-content text-center p-2 mb-4 mt-4 -->
            </div> <!-- cd-timeline-block -->
