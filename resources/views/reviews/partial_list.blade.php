    ...
    <div class="clearfix">
        @if ($review->screenshots->isNotEmpty())
            ...
            <a class="lightbox-link" href="{{ asset('storage/images/game_screenshots/'.$screenshot->file) }}">
                <img class="col-4 col-sm-3 float-left mt-1 mr-2 mb-1" src="{{ asset('storage/images/game_screenshots/'.$screenshot->file) }}" alt="Screenshot of {{ $review->games->first()->game_name }}">
            </a>
        @endif
