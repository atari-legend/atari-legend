...
<head>
    ...
    element on most pages, but it's set by a CSS rule, so the browser only reaches it
    once the stylesheet above has downloaded and been parsed. Preloading it here starts
    the fetch while that is still happening. --}}
