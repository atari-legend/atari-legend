                ...
                <div class="col-12 col-md-6">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="datetime-local" required class="form-control @error('published_at') is-invalid @enderror" name="published_at"
                            id="published_at"
                            value="{{ old('published_at', isset($review) ? $review->published_at?->format('Y-m-d\TH:i') : now()->format('Y-m-d\TH:i')) }}">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-10">
                                    <input type="text" class="form-control @error('screenshot_comment_'.$screenshot->getKey()) is-invalid @enderror" id="screenshot-comment-{{ $screenshot->getKey() }}"
                                        value="{{ old('screenshot_comment_'.$screenshot->getKey(), isset($review) ? $review->getScreenshotComment($screenshot->getKey())?->pivot?->description : '') }}"
