            ...
            <div class="mb-3 row row-cols-2">
                <div class="col">
                    ...
                    <input type="number" class="form-control @error('players') is-invalid @enderror"
                        name="players" id="players" value="{{ old('players', $game->players_same_machine ?? '') }}">
                ...
                <div class="col">
                    ...
                    <input type="number" class="form-control @error('players_linked') is-invalid @enderror"
                        name="players_linked" id="players_linked" value="{{ old('players_linked', $game->players_multiple_machines ?? '') }}">
