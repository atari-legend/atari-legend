<nav>
    ...
    <div class="accordion">
        ...
        <div class="accordion-item">
            <h2 class="accordion-header">
                <button class="accordion-button @collapsedroute('admin.reviews.*') collapsed p-1 py-2 text-muted border-0 rounded-0" type="button" data-bs-toggle="collapse" data-bs-target="#reviews" aria-expanded="false" aria-controls="reviews">
